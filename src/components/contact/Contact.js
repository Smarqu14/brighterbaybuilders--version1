    ...
    <div className='contact__container' id='contact'>
      <Fade top>
        <div className='contact__text'>
          ...
          <p>
            From concept to completion, every step of a project is handled by
            our team of engineers, architects, construction crew, and interior
            designers. Renovation and preservation projects are done with care
            and concern for architectural and structural integrity as well as
            beauty and function.
          </p>
        </div>
